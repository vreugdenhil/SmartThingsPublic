...
def configureAfterSecure() {
    log.debug "configureAfterSecure()"
        secureSequence([
        //zwave.configurationV1.configurationSet(parameterNumber: 9, size: 1, scaledConfigurationValue: 0),  // State of the device after a power failure
        ...
        zwave.configurationV1.configurationSet(parameterNumber: 32, size: 1, scaledConfigurationValue: 2),  // On/Off Mode (0=Dimmer,1=On/Off,2=Auto)
