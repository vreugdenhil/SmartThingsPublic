metadata {
definition (name: "Qubino Dual Relay", namespace: "Smartthings", author: "Martijn Vreugdenhil") {
capability "Switch"
capability "Polling"
...
tiles(scale: 2){
	...
	preferences {
    	...
    	input name: "parameter1", type: "number", title: "Input 1 switch type", defaultValue: 0, displayDuringSetup: false, required: false
        input name: "parameter2", type: "number", title: "Input 2 switch type", defaultValue: 0, displayDuringSetup: false, required: false
  }
}
